      ...
      <nav className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <Link href="/cjenik" className="text-gray-700 hover:text-blue-600 transition">
              Cjenik
            </Link>
            <Link href="/galerija" className="text-gray-700 hover:text-blue-600 transition">
              Galerija
            </Link>
            <Link href="/o-nama" className="text-gray-700 hover:text-blue-600 transition">
              O nama
            </Link>
            <Link
              href="/rezerviraj"
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 pb-4 space-y-2">
            ...
            <Link href="/usluge" className="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded">
              Usluge
            </Link>
            <Link href="/cjenik" className="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded">
              Cjenik
            </Link>
            <Link href="/galerija" className="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded">
              Galerija
            </Link>
            <Link href="/o-nama" className="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded">
              O nama
            </Link>
            <Link
              href="/rezerviraj"
